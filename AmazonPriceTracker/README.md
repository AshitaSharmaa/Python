...
Which in turn send me email specifying that now i can buy the product.
I used Python bot to automate this process. I launched this code on python Anwhere App and 
I have scdeuled it for 9am every morning which automaticaaly run the code and check for the price 
