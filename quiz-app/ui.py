...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.label = Label(text = f"Score: {self.score}", bg = THEME_COLOR, highlightthickness = 0, fg = "white")
        ...
        #not using self as check_img is not going to used anywhere else
        check_img = PhotoImage(file = "images/true.png")
        self.right_button = Button(image = check_img, command = self.true_pressed)
